...
--
-- Host: localhost    Database: db_java
-- ------------------------------------------------------
...
CREATE TABLE `food_table` (
  ...
  `FoodSize` varchar(45) DEFAULT NULL,
  `FoodShare` int(11) DEFAULT NULL,
  `FoodMoney` int(11) DEFAULT NULL,
  `FoodName` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`FoodNumber`),
  UNIQUE KEY `FoodNumber_UNIQUE` (`FoodNumber`)
...
-- Dump completed on 2019-06-08 16:32:17
